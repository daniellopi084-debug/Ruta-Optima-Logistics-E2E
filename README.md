...
4. Abrir Power BI, acceder a *Transformar Datos* y modificar la variable `ruta_db` en el origen del script de Python con la ruta de la máquina local. Hacer clic en **Actualizar** en el lienzo para sincronizar las gráficas de manifiestos en tiempo real.
